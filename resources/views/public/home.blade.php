	...
	<div class="container mt-5">
		<div class="row justify-content-center">
			<div class="col-md-3 mr-3 text-center p-3 box-catalog rounded">
				<a href="{{url('/koleksi-buku')}}" class="links">
					<h5>Buku</h5>
					<img src="{{url('/assets/icon/open-book.png')}}" alt="book" width="77">
				</a>
			</div>
			...
			<div class="col-md-3 mr-3 text-center rounded p-3 box-catalog">
				<a href="" class="links">
					<h5>Majalah</h5>
					<img src="{{url('/assets/icon/magazine.png')}}" alt="book" width="77">
				</a>
			</div>
			...
			<div class="col-md-3 mr-3 text-center rounded p-3 box-catalog">
				<a href="" class="links">
					<h5>Journal</h5>
					<img src="{{url('/assets/icon/journal.png')}}" alt="book" width="77">
				</a>
			</div>
		</div>
		<br>
		<div class="row justify-content-center">
			<div class="col-md-3 mr-3 text-center p-3 box-catalog rounded">
				<a href="" class="links">
					<h5>E-book</h5>
					<img src="{{url('/assets/icon/ebook.png')}}" alt="book" width="77">
				</a>
			</div>
			...
			<div class="col-md-3 mr-3 text-center p-3 box-catalog rounded">
				<a href="" class="links">
					<h5>Comic</h5>
					<img src="{{url('/assets/icon/comic.png')}}" alt="book" width="77">
				</a>
			</div>
			...
			<div class="col-md-3 mr-3 text-center p-3 box-catalog rounded">
				<a href="" class="links">
					<h5>Novel</h5>
					<img src="{{url('/assets/icon/novel.png')}}" alt="book" width="77">
				</a>
			</div>
		</div>
	</div>
