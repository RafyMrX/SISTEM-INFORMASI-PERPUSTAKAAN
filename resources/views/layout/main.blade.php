...
<head>
	...
	<!-- Icon -->
	<link rel="icon" href="{{url('/assets/img/brand/logosby.png')}}"  type = "image/x-icon">
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top">
		<div class="container">
			<a class="navbar-brand" href="#" style="color: #fff;"><img src="{{url('/assets/img/brand/logosby.png')}}" alt="" width="32"> Perpustakaan Surabaya</a>
